...
<div class="space-y-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <!-- Corte (Periodos) -->
        <a href="{{ route('sistema.cortes.index') }}" class="group bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center justify-between mt-auto">
                    <span class="text-[0.65rem] font-black uppercase tracking-widest text-slate-400">{{ $corteCount }} Registros</span>
        ...
        <!-- Responsables -->
        <a href="{{ route('sistema.responsables.index') }}" class="group bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center justify-between mt-auto">
                    <span class="text-[0.65rem] font-black uppercase tracking-widest text-slate-400">{{ $responsableCount }} Registros</span>
        ...
        <!-- Proveedores -->
        <a href="{{ route('sistema.proveedores.index') }}" class="group bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center justify-between mt-auto">
                    <span class="text-[0.65rem] font-black uppercase tracking-widest text-slate-400">{{ $proveedorCount }} Registros</span>
        ...
        <!-- Estados -->
        <a href="{{ route('sistema.estados.index') }}" class="group bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center justify-between mt-auto">
                    <span class="text-[0.65rem] font-black uppercase tracking-widest text-slate-400">{{ $estadoCount }} Registros</span>
        ...
        <!-- Empresas -->
        <a href="{{ route('sistema.empresas.index') }}" class="group bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center justify-between mt-auto">
                    <span class="text-[0.65rem] font-black uppercase tracking-widest text-slate-400">{{ $empresaCount }} Registros</span>
        ...
        @hasanyrole('Admin')
        <a href="{{ route('sistema.usuarios.index') }}" class="group bg-slate-900 rounded-3xl p-8 shadow-xl border border-slate-800 hover:shadow-2xl hover:shadow-slate-500/10 transition-all duration-300 relative overflow-hidden text-white">
            ...
            <div class="relative z-10">
                ...
                <p class="text-sm text-slate-400 leading-relaxed font-medium mb-12">Control de acceso y perfiles de seguridad centralizados.</p>
                <div class="flex items-center justify-between mt-auto">
                    <span class="text-[0.65rem] font-black uppercase tracking-widest text-slate-500">{{ $userCount }} Cuentas</span>
    ...
    <div class="bg-surface-container-low p-8 rounded-[40px] border border-slate-200/50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 flex items-center justify-between group hover:border-primary/20 transition-all">
                ...
                <a href="{{ route('sistema.empresas.enrich') }}" class="bg-slate-100 text-slate-600 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-900 hover:text-white transition-all">Ir a Módulo</a>
            </div>

            <div class="bg-primary/5 p-6 rounded-3xl border border-primary/10 flex items-center justify-between group hover:border-primary/30 transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-black text-slate-800">Sincronizar Cloud</h4>
                        <p class="text-xs text-slate-400 font-bold uppercase tracking-widest">Traer catálogos de Firebase</p>
                    </div>
                </div>
                <form action="{{ route('intranet.catalogo.sync_firebase') }}" method="POST">
                    @csrf
                    <button type="submit" class="bg-primary text-white px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-900 transition-all">Sincronizar Todo</button>
                </form>
            </div>
        </div>
    </div>
